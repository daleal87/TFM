...
std_msgs::Int32 accion_ard2_msg, accion_p3at_msg, velocidad_cable_msg;
...
void longitudcableCallback(const std_msgs::Float64::ConstPtr& msg)
{
    ...
    if (longitud_cable > long_cable_max) // Comprobamos que no supere la distancia maxima permitida
    {
