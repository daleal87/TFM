...
int main(int argc, char **argv)
{
    ...
    ros::Publisher p3at_pose_pub = node.advertise<geometry_msgs::Pose>("guiado/pose_p3at", 10);
    ros::Publisher ard2_pose_pub = node.advertise<geometry_msgs::Pose>("guiado/pose_ard2", 10);

    // Mensajes
    std_msgs::Float64 p3at_d_obj_msg, p3at_o_obj_msg;
    ...
    while (node.ok()){
          ...
          p3at_d_obj_pub.publish(p3at_d_obj_msg);
          p3at_o_obj_pub.publish(p3at_o_obj_msg);
