#ifndef _ROS_SERVICE_SemanticQueryAllDirectChildren_h
#define _ROS_SERVICE_SemanticQueryAllDirectChildren_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SEMANTICQUERYALLDIRECTCHILDREN[] = "semantic_knowledgebase_messages/SemanticQueryAllDirectChildren";

  class SemanticQueryAllDirectChildrenRequest : public ros::Msg
  {
    public:
      const char* parent;
    ...
    const char * getType(){ return SEMANTICQUERYALLDIRECTCHILDREN; };
    const char * getMD5(){ return "2bd90c00241b835336402ad130902710"; };

  };

  class SemanticQueryAllDirectChildrenResponse : public ros::Msg
  {
    public:
  ...
  class SemanticQueryAllDirectChildren {
    public:
    typedef SemanticQueryAllDirectChildrenRequest Request;
    typedef SemanticQueryAllDirectChildrenResponse Response;
  };
