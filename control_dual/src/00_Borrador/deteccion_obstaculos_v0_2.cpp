...
std_msgs::Int32 accion_ard2_msg, accion_p3at_msg, altura_a_suelo_msg;
...
int main(int argc, char **argv)
{
    ...
    ros::Publisher altura_a_suelo_pub = node.advertise<std_msgs::Int32>("ardrone/altura_a_suelo", 10);
    ...
    while (node.ok()){
          ...
          if (proyeccion_xy <= dist_centro_plataforma && accion_ard2 <= ARD2_VUELOSOBRESUELO) {
              ...
              altura_a_suelo_pub.data = h_kalman_sonar + h_plataforma;
          }
          // CONDICION 2 ||  __OK__
              ...
              altura_a_suelo_pub.data = h_kalman_sonar;
          }
          // CONDICION 3
              ...
              altura_a_suelo_pub.data = h_kalman_sonar + h_obstaculo;
          ...
          // CONDICION 4
              ...
              //            - IMPORTANTE: es posible que el drone deje de detectar el obstaculo si se sale del punto
              //              por lo que la altura_a_suelo debera corregirse tambien dentro de esta condicion, dado que
              //              por los estados no va a entrar en las otras condiciones. Tendra que depender de obstaculo_detectado.
          }
          // CONDICION 5
