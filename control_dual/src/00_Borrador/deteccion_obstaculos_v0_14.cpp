...
int main(int argc, char **argv)
{
    ...
    while (node.ok()){
          ...
          else if (obstaculo_detectado && accion_ard2 == ARD2_VUELOSOBRESUELO)
          {
              ...
              pose_obj_p3at.position.x = pose_ard2.position.x; // TO_DO: esquiva
              pose_obj_p3at.position.y = pose_ard2.position.y; // TO_DO: esquiva
          ...
          else if (accion_ard2 == ARD2_MARCAJEOBSTACULO && accion_p3at == P3AT_ESQUIVAOBSTACULO)
          {
              ...
              if (accion_p3at = P3AT_ESPERAPIONNER) { accion_ard2 = ARD2_APIONEER; }
