...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber kalman_ard2_odom_subs = node.subscribe(ard2_pose_topic_name, 1, ard2kalmanodomCallback);
    ros::Subscriber kalman_sonar_subs = node.subscribe(sonar_topic_name, 1, ard2kalmansonarCallback);
    ros::Subscriber kalman_p3at_odom_subs = node.subscribe(p3at_pose_topic_name, 1, p3atkalmanodomCallback);
    ...
    while (node.ok()){
        ...
        {
            longitud_objetivo_msg.data = (altura_vuelo - altura_plataforma) * k_recogida_cable;
        }
        ...
        else if (accion_ard2 != EMERGENCIA || accion_p3at != EMERGENCIA)
        {
            ...
            longitud_objetivo_msg.data = (int)longitud_objetivo_float;
            if (longitud_objetivo_msg.data < 500) {longitud_objetivo_msg.data = 500;}
