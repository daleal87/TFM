#ifndef _ROS_SERVICE_SemanticQueryIsChild_h
#define _ROS_SERVICE_SemanticQueryIsChild_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SEMANTICQUERYISCHILD[] = "semantic_knowledgebase_messages/SemanticQueryIsChild";

  class SemanticQueryIsChildRequest : public ros::Msg
  {
    public:
      const char* child;
      const char* parent;
    ...
    const char * getType(){ return SEMANTICQUERYISCHILD; };
    const char * getMD5(){ return "97b5d37812c0ed48c761edb7c17bdf4d"; };

  };

  class SemanticQueryIsChildResponse : public ros::Msg
  {
    public:
      bool result;
  ...
  class SemanticQueryIsChild {
    public:
    typedef SemanticQueryIsChildRequest Request;
    typedef SemanticQueryIsChildResponse Response;
  };
