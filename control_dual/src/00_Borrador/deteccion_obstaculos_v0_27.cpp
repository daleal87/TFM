...
double proyeccion_xy, orientacion_cable, inclinacion_cable; // Informacion sobre el cable
...
{
    inclinacion_cable = inclinacion_cable_msg->data; // Leemos el valor del topic que indica la orientacion del cable
}
