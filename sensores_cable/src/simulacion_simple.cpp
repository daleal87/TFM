...
int main(int argc, char **argv)
{
  ...
  ros::Publisher longitud_cable_pub = node.advertise<std_msgs::Int32>("/cable/longitud", 1);
  ...
  std_msgs::Int32 longitud_cable_msg;
  ...
  while (node.ok()){
    ...
    longitud_cable_msg.data = (int)(dist_robots_msg.data * 1000);
