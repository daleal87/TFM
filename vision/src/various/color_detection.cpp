...
int main(int argc, char **argv)
{
    ...
    */
    ...
    cv::namedWindow("Ball");
    cv::createTrackbar("LowerH","Ball",&LowerH,179,NULL);
    cv::createTrackbar("UpperH","Ball",&UpperH,179,NULL);
    ...
    */
    ...
    image_transport::Subscriber sub = it.subscribe("/ardrone/bottom/image_raw", 1, colorDetectionCallback);
